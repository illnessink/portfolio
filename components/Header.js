        ...
        '>
            ...
            '>
                <nav className="flex items-center flex-col justify-center">
                        <MobileLink href="/" title="Home" className='mr-4' toggle={handleClick}/>
                        <MobileLink href="/about" title="About" className='mx-4' toggle={handleClick}/>
                        <MobileLink href="/projects" title="Projects" className='ml-4' toggle={handleClick}/>
                        <MobileLink href="/contact" title="Contact"  className='mx-4' toggle={handleClick}/>
                </nav>
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://github.com/illnessink" target={"_blank"}
                    whileHover={{y:-2}}
